...
exports.listInvoiceModuleStatuss = async (req, res, next) => {
  try {
    const allInvoiceModuleStatus = await InvoiceModuleStatus.findAndCountAll();
    let { page, limit, name } = req.query;

    console.log("unitt", allInvoiceModuleStatus.count);
    ...
    const total = allInvoiceModuleStatus.count;
    ...
    // res.send(allInvoiceModuleStatus);
    return res.send({
      success: true,
