...
exports.listLeadsManagmentModuleStatuss = async (req, res, next) => {
  try {
    const allLeadsStatuss = await LeadsManagmentModuleStatus.findAndCountAll();
    let { page, limit, name } = req.query;

    console.log("unitt", allLeadsStatuss.count);
    ...
    const total = allLeadsStatuss.count;
